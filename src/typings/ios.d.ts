...
declare class SDImageCache extends NSObject implements SDImageCacheProtocol {
    ...
    queryCacheOperationForKeyOptionsContextDone(
        key: string,
    ...
    queryImageForKeyOptionsContextCompletion(
        key: string,
        options: SDWebImageOptions,
        context: NSDictionary<string, any>,
        completionBlock: (p1: UIImage, p2: NSData, p3: SDImageCacheType) => void
    ): SDWebImageOperation;
...
interface SDImageLoader extends NSObjectProtocol {
    ...
    loadImageWithURLOptionsContextProgressCompleted(
        url: NSURL,
        options: SDWebImageOptions,
        context: NSDictionary<string, any>,
...
declare function SDImageLoaderDecodeProgressiveImageData(
    imageData: NSData,
    imageURL: NSURL,
    finished: boolean,
...
declare function SDMemoryCacheCostForImage(image: UIImage): number;
...
declare class SDWebImageDownloader extends NSObject implements SDImageLoader {
    ...
    downloadImageWithURLOptionsContextProgressCompleted(
        url: NSURL,
...
interface SDWebImageDownloaderOperationProtocol extends NSURLSessionDataDelegate, NSURLSessionTaskDelegate {
    ...
    initWithRequestInSessionOptionsContext?(
        request: NSURLRequest,
        session: NSURLSession,
        options: SDWebImageDownloaderOptions,
        context: NSDictionary<string, any>
...
declare class SDWebImageManager extends NSObject {
    ...
    loadImageWithURLOptionsContextProgressCompleted(
        ...
        context: NSDictionary<string, any>,
        progressBlock: (p1: number, p2: number, p3: NSURL) => void,
        completedBlock: (p1: UIImage, p2: NSData, p3: NSError, p4: SDImageCacheType, p5: boolean, p6: NSURL) => void
